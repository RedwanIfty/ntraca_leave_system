...
<center>
    <div class="panel-body">
        <div class="portlet-body form">
            <form   class="form-horizontal" method="post"  action="{{route('reject.applicationStore',$applications->id)}}"  enctype="multipart/form-data" accept-charset="utf-8" autocomplete="off">
                @csrf
                ...
                <div class="form-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            ...
                            <input class="form-control" name="approved_start_date" type="date" id="date1" value="{{$applications->start_date}}" readonly>
                        </div>
                        <div class="col-md-2">
                            <Label>ছুটির মেয়াদকাল শেষ</Label>
                            <input class="form-control" name="approved_end_date" id="date2" type="date" value="{{$applications->end_date}}" readonly>
                        </div>
                ...
                <div class="form-group ">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <button type="submit"  class="btn btn-success sav_btn"> বাতিল</button>
                        </div>
